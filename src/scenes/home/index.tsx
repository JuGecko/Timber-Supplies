...
const Home = ({ setSelectedPage }: Props)  => {
    ...
    >
        ...
        <div className='z-10 mt-32 md:basis-3/5'>
            {/* HEADINGS */}
            {/* the section below will be pushed a lil higher */}
            <motion.div
             className='md:-mt-20'
             initial="hidden"
             whileInView="visible"
             ...
             >
                ...
                <p className='mt-8 text-sm'>
                    ...
                    Natus totam, sint asperiores alias quisquam eius. alias quisquam eius.
                </p>
            </motion.div>
        ...
        <div className='h-[150px] w-full bg-primary-100 py-10'>
            <div className='mx-auto w-5/6'>
                <div className='flex w-3/5 itmes-center justify-between gap-8'>
                    <img src={SponsorRedbull} alt="redbull-sposor" />
                    <img src={SponsorForbes} alt="forbes-sposor" />
                    <img src={SponsorFortune} alt="fortune-sposor" />
                </div>
            </div>
        </div>
        )}
